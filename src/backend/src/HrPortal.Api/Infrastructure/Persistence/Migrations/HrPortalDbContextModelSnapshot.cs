...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrPortal.Projects.Domain.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HrPortal.Projects.Domain.ProjectMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HrPortal.Tasks.Domain.ProjectTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("project_tasks", "tasks");
                });

            modelBuilder.Entity("HrPortal.TimeTracking.Domain.TimeEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "EmployeeId", "StartTime");
            ...
            modelBuilder.Entity("HrPortal.Projects.Domain.ProjectMember", b =>
                {
                    b.HasOne("HrPortal.Projects.Domain.Project", null)
                        .WithMany()
