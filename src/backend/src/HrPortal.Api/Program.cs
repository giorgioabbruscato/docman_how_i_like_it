...
using HrPortal.Tasks;
using HrPortal.TimeTracking;
using HrPortal.Calendar;
using HrPortal.Identity;
using HrPortal.Leave;
using HrPortal.Notifications;
using HrPortal.Workflows;
using HrPortal.Integrations;
...
builder.Services.AddHrPortalWorkflows();
builder.Services.AddHrPortalIntegrations(builder.Configuration, builder.Environment);
